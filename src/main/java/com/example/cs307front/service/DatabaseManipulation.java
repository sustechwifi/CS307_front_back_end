...
import com.example.cs307front.interfaces.*;
import com.example.cs307front.utils.ItemRecord;
import com.example.cs307front.utils.StaffRecord;
...
//            e.printStackTrace();
            try {connection.prepareStatement("drop table undertake;").execute();}catch (Exception ignored){}
            try {connection.prepareStatement("drop table record;").execute();}catch (Exception ignored){}
            try {connection.prepareStatement("drop table container;").execute();}catch (Exception ignored){}
            try {connection.prepareStatement("drop table ship;").execute();}catch (Exception ignored){}
            try {connection.prepareStatement("drop table staff;").execute();}catch (Exception ignored){}
            try {connection.prepareStatement("drop table city;").execute();}catch (Exception ignored){}
            try {connection.prepareStatement("drop table company;").execute();}catch (Exception ignored){}
            try {
                connection.close();
